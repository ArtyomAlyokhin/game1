...
const audioTak = new Audio('/game1/tak.mp4')
const audioWin = new Audio('/game1/win.mp3')
const audioNope = new Audio('/game1/nope.mp3')
const audioNan = new Audio('/game1/nan.mp3')
const audioPov = new Audio('/game1/povorot.mp3')
